...
****
## Кубернетовый кластер <a name="67"></a>
...
****
## Включенные компоненты <a name="69"></a>
...
****
## Рекомендуемые технологии <a name="6a"></a>
...
****
## Настройка и запуск шаблона <a name="6d"></a>
...
****
## Создание кластера Kubernetes в облаке IBM <a name="6e"></a>
...
****
## Доступ к кластеру Kubernetes <a name="610"></a>
  
...
    ```
    
## Разворачивание сети Hyperledger в кластер Kubernetes <a name="611"></a>
...
## Сценарий конфигурации Kubernetes <a name="612"></a>
