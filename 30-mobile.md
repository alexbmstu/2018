...
![](Что необходимо установить для iOS_html_2d196317aa6bb516.png)

После установки, IDE отобразится в меню приложений:

![](Что необходимо установить для iOS_html_95debbd82af313ff.png)
...
![](Что необходимо установить для iOS_html_c06e4f2a185a5031.png)
...
![](Что необходимо установить для iOS_html_b818428146844971.jpg)

2) Зайти в приложение Cardiio

![](Что необходимо установить для iOS_html_582217324c415d5c.jpg)

3) Зайти в настройки и проскроллить до секции AppleHealth, после чего включить интеграцию с Health

![](Что необходимо установить для iOS_html_a66391c66f8a8299.jpg)

4) После измерения пульса, данные можно будет увидеть в Health

![](Что необходимо установить для iOS_html_2f275c92138b7eca.jpg)
...
![](Что необходимо установить для iOS_html_4b6eb75e2df605fe.jpg)

Чтобы собирать данные о питании необходимо проделать следующие шаги:

1) Установить приложение FatSecret

![](Что необходимо установить для iOS_html_61a282a276905974.jpg)

2) Зайти в настройки приложения и включить интеграцию с Health

![](Что необходимо установить для iOS_html_ebea3cd28a29ae1c.jpg)

3) Добавить прием пищи в приложение

![](Что необходимо установить для iOS_html_7af205cc846dc391.jpg)

4) После этого вся информации о питании будет доступна в Health

![](Что необходимо установить для iOS_html_6b91a9fa11f1d15f.jpg)
...
![](Что необходимо установить для iOS_html_3078659d9baa9bab.jpg)

2) Включить в настройках интеграцию с Health

![](Что необходимо установить для iOS_html_c488a74b92455944.jpg)

3) Далее после медитации под какую-нибудь бесплатную мелодию данные о медитации отправятся в Health

![](Что необходимо установить для iOS_html_141b413dd1351942.jpg)
